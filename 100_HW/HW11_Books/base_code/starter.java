	...
	public static void main(String args[]) throws FileNotFoundException {
		...
		*/
		while(true){
			...
			if (choice.equals("4")){
				System.out.print("How many words would you like printed: ");
				int words = sc.nextInt();
				printsNumber(arr, words);
			}
			
			if (choice.equals("5")){
				System.out.print("Which text file would you like to switch to: ");
			...
			if (choice.equals("6")){
				...
				int sum = checksArray(arr, word);
				System.out.println("The word "+word+" was found "+sum+" times.");
			}
			
			if (choice.equals("7")){
				String common = mostCommon(arr);
				System.out.println("The word "+common+" was found the most times.");
			}
